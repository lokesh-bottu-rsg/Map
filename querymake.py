...
dic = {'IN_MEDIA_OUTLET_ID': '96','IN_QTR': '1Q25','IN_OUTPUT_TYPE': '1','IN_PLAN_ID': '447'}
...
'''
SELECT 'PR_PLAN' TABLE_NAME ,COUNT(*)  CNT FROM PR_PLAN UNION
SELECT 'PR_CAMPAIGN_GOAL' TABLE_NAME ,COUNT(*)  CNT FROM PR_CAMPAIGN_GOAL UNION
SELECT 'PR_CAMPAIGN_GOAL_EPISODE' TABLE_NAME ,COUNT(*)  CNT FROM PR_CAMPAIGN_GOAL_EPISODE UNION
SELECT 'PR_PLAN_SCHEDULE' TABLE_NAME ,COUNT(*)  CNT FROM PR_PLAN_SCHEDULE UNION
SELECT 'PR_PLAN_SCHEDULE_EPISODE' TABLE_NAME ,COUNT(*)  CNT FROM PR_PLAN_SCHEDULE_EPISODE UNION
SELECT 'PR_PLAN_PROJECT' TABLE_NAME ,COUNT(*)  CNT FROM PR_PLAN_PROJECT UNION
SELECT 'PR_PLAN_PROJECT_EPISODE' TABLE_NAME ,COUNT(*)  CNT FROM PR_PLAN_PROJECT_EPISODE UNION
SELECT 'PR_PLAN_PROJECT_SPOTS' TABLE_NAME ,COUNT(*)  CNT FROM PR_PLAN_PROJECT_SPOTS UNION
SELECT 'PR_PLAN_PROJECT_SPOTS_EPISODE' TABLE_NAME ,COUNT(*)  CNT FROM PR_PLAN_PROJECT_SPOTS_EPISODE UNION
SELECT 'PR_PLAN_PROJECT_SPOTS_EPISODE_MAP' TABLE_NAME ,COUNT(*)  CNT FROM PR_PLAN_PROJECT_SPOTS_EPISODE_MAP UNION
SELECT 'PR_PLAN_VERSION' TABLE_NAME ,COUNT(*)  CNT FROM PR_PLAN_VERSION UNION
SELECT 'MODEL_EXEC' TABLE_NAME ,COUNT(*)  CNT FROM MODEL_EXEC ORDER BY CNT;
'''