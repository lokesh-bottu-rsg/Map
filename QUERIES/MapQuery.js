module.exports = {
	mapQuery: {
		...
		quarterlyMapPlannedProjectsData: `
										...
										SELECT PLAN_ID,PROJECT_ID FROM CTE_PAST_QTR_DATA GROUP BY PLAN_ID,PROJECT_ID
										UNION
										SELECT PLAN_ID,PROJECT_ID FROM CTE_CUR_QTR_DATA GROUP BY PLAN_ID,PROJECT_ID
									)
										...
										, CTE_PLAN_ENDDATE AS (
											...
											JOIN CTE_PLAN_PROJECTS CP ON PPP.PLAN_ID = CP.PLAN_ID AND PPP.PROJECT_ID = CP.PROJECT_ID 
										...
										, CTE_VERSION AS (
											...
											SELECT PROJECT_ID, LAST_OPT_VERSION_TS
										...
										LEFT JOIN CTE_VERSION CV ON CV.PROJECT_ID =PPR.PROJECT_ID
		...
		weeklyMapPlannedProjectsData: `
									...
									,CTE_FINAL AS(
												SELECT CD.* EXCLUDE(PLAN_ID),LAST_OPT_VERSION_TS FROM CTE_PLANNED_DATA CD 
